...
export default function Menu (){
    ...
    return(<main className='main'>
        ...
        <div className='flex justify-center items-center gap-5 pl-5 pr-5 flex-wrap'>
            <div className='p-1 border-2 rounded-lg border-black gap-1 flex flex-col items-center justify-center w-72 h-72'>
                <Image src={'https://i.pinimg.com/originals/97/3e/ae/973eae0b4824c1317d22061cbce36f56.jpg'} alt={'Image pokemons in library'}
            ...
            <div className='p-1 border-2 rounded-lg border-black gap-1 flex items-center justify-center flex-col w-72 h-72'>
                <Image
            ...
            <div className='p-1 border-2 rounded-lg border-black gap-1 items-center justify-center flex flex-col w-72 h-72'>
                <Image
            ...
            <div className='p-1 border-2 rounded-lg border-black items-center justify-center gap-1 flex flex-col w-72 h-72'>
                <Image
            ...
            <div className='p-1 border-2 rounded-lg border-black justify-center items-center gap-1 flex flex-col w-72 h-72'>
                <Image
